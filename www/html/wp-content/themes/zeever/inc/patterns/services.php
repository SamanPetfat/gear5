...
return array(
    ...
    'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"100px","bottom":"100px"}}},"backgroundColor":"zeever-bgsoft","layout":{"wideSize":"1170px","contentSize":"1170px"}} -->
                ...
                <h2 class="has-text-align-left has-black-color has-text-color has-heading-3-font-size" style="font-style:normal;font-weight:600;margin-top:20px">UI Design</h2>
                <!-- /wp:heading -->
                ...
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-heading-3-font-size" style="font-style:normal;font-weight:600;margin-top:30px;margin-bottom:20px">Content Writing</h2>
                <!-- /wp:heading -->
                ...
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-heading-3-font-size" style="font-style:normal;font-weight:600;margin-top:20px">Marketing Strategy</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"heading-3"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-heading-3-font-size" style="font-style:normal;font-weight:600;margin-top:20px">Web Development</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"heading-3"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-heading-3-font-size" style="font-style:normal;font-weight:600;margin-top:20px">Social Media</h2>
                <!-- /wp:heading -->
