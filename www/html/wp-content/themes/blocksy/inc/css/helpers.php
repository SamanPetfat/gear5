...
if (! function_exists('blocksy_output_border')) {
    function blocksy_output_border($args = [])
    {
        ...
        if (isset($value['desktop']['inherit'])
            &&
        ...
        if (isset($value['desktop']['secondColor'])
            &&
